              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <?php
                        $sql = "SELECT id, model, color FROM cars ORDER BY model;";
...
<?php
    while ($cars = $result->fetch_assoc()) {
        ...
        echo('<td><a href="brands_edit.php?id=' . $cars['id'] . '"><i class="fa  fa-pencil" aria-hidden="true"></i></a><td>');
        echo('<td><a href="brands_delete.php?id=' . $cars['id'] . '"><i class="fa  fa-trash" aria-hidden="true"></i></a><td>');
        echo('</tr>');
    }
?>                        
                      </tbody>
